...
// Dev-build v1.8.0 (contract v1.15, FIL/PRI wave, beta.6) → 305; KG v1.12.0 → 306 (+CIC-011)
...
describe("rdf projection (v2 / s1)", () => {
  it("loads every source with expected counts (no silent skip)", () => {
    ...
    expect(counts["requirement_control_links"]).toBe(306); // KG v1.12.0: +CIC-011
    ...
    const sum = 529 + 306 + 2 + 5 + 11; // KG v1.12.0: +CIC-011
