...
reasoning: v0.20.0-beta.12 (beta line, npm `beta`) — absorbs stable 0.16.0 («data debt» served): re-pin dev-build kg-v1-manual-v1.8.0-aligned-2026-09-02 (contract v1.16 §1.23), guide artifacts 25/25, threat associated_control_names 95/95 + antipatterns, plan artefact_totals 45/469 from bundle meta, provenance stamp dev:<sha12>. New v1.16 fields are outside the RDF projection (declared); trace unchanged. Golden 10/10, gate E PASS, 24/24 tools, budgets inside gates.
