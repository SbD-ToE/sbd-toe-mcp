...
`check`; smoke; `eval:acceptance` 141/16/0/23 gate PASS; Eixo H 10/10. Pino KG v1.12.0 inalterado. **Sem versão, sem tag, sem
publicação** — o release é decisão do lead.
