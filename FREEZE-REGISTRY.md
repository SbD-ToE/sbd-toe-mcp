...
**Beta line:** v0.20.0-beta.43 → `PENDING` (2026-09-08; `release.yml` run PENDING publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.43` = `beta`, gitHead igual; GitHub pre-release) expõe a ontologia v2.7, e o que
