...
**Beta line:** v0.20.0-beta.38 → `6169d50d57683de517b15e460e0041ebdaf2393b` (2026-09-07; `release.yml` run PENDING publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.38` = `beta`, gitHead igual; GitHub pre-release) fecha um defeito
