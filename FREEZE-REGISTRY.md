...
**Beta line:** v0.20.0-beta.41 → `PENDING` (2026-09-08; `release.yml` run PENDING publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.41` = `beta`, gitHead igual; GitHub pre-release) fecha os dois bloqueios da 2.ª
