...
**Beta line:** v0.20.0-beta.40 → `43afda8e8736a3f066be2aea07106b2f94375db1` (2026-09-07; `release.yml` run PENDING publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.40` = `beta`, gitHead igual; GitHub pre-release) responde à dúvida que
