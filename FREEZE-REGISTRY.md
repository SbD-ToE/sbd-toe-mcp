...
**Beta line:** v0.20.0-beta.42 → `e9233dc0fb56b2a463633712876e8f5592b6486b` (2026-09-08; `release.yml` run PENDING publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.42` = `beta`, gitHead igual; GitHub pre-release) fecha as 13 células
