...
**Beta line:** v0.20.0-beta.45 → `PENDING` (2026-09-08; `release.yml` run PENDING publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.45` = `beta`, gitHead igual; GitHub pre-release) traz o Manual v1.9.0 ao serving
