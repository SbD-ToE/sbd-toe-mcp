...
**Beta line:** v0.20.0-beta.47 → `PENDING` (2026-09-09; `release.yml` run PENDING publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.47` = `beta`, gitHead igual; GitHub pre-release) fecha os resíduos da 3.ª
