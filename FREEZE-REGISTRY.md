...
**Beta line:** v0.20.0-beta.49 → `PENDING` (2026-09-10; `release.yml` run PENDING publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.49` = `beta`, gitHead igual; GitHub pre-release) fecha uma omissão com efeito
