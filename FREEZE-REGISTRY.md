...
**Beta line:** v0.20.0-beta.48 → `2b09aede4ecaadf4ef651a9c2df70c645fc0a842` (2026-09-10; `release.yml` run 34422540156 publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.48` = `beta`, gitHead igual; GitHub pre-release) assenta na primeira release
