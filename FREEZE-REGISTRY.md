...
**Beta line:** v0.20.0-beta.49 → `a6609be5202d484e88b0bd96946ada3fdfb3fce6` (2026-09-10; `release.yml` run PENDING publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.49` = `beta`, gitHead igual; GitHub pre-release) fecha uma omissão com efeito
