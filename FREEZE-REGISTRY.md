...
| 2026-09-26 | v0.21.1 registered (patch da linha 0.21: o overlay regulatório do `prepare` restringe-se ao âmbito activado — defeito presente em 0.19.4/0.20.0/0.21.0, RGPD 1 693 mapeamentos → 85 servidos + contados em `mappings_scope` com `rest_ref`; obrigações e conjunto citável inalterados; bundle pin unchanged KG v1.12.0). Tag on the squash commit introducing this row. 0.21.0, 0.20.0 e 0.19.4 intocadas e alcançáveis. | Claude Opus 5.5 (Pontifex), authorised by Pedro Farinha |
