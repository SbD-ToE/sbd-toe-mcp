...
**Beta line:** v0.20.0-beta.47 → `b5fa4f538a68bd138eb03137a9b235e7213d8238` (2026-09-09; `release.yml` run PENDING publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.47` = `beta`, gitHead igual; GitHub pre-release) fecha os resíduos da 3.ª
