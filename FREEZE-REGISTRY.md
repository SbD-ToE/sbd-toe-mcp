...
- v0.16.1 *(lote formal — re-pin release KG v1.10.0 (sha `d8df472b…`, digest-verified;
  byte-igual ao dev-build 2026-09-02); stamp v1.10.0; annotated tag on the squash after
  merge; npm `latest` via release.yml)*
