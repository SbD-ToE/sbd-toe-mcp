...
**Beta line:** v0.20.0-beta.40 → `PENDING` (2026-09-07; `release.yml` run PENDING publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.40` = `beta`, gitHead igual; GitHub pre-release) responde à dúvida que
