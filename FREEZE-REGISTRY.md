...
**Beta line:** v0.20.0-beta.48 → `PENDING` (2026-09-10; `release.yml` run PENDING publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.48` = `beta`, gitHead igual; GitHub pre-release) assenta na primeira release
