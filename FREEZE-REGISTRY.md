...
**Beta line:** v0.20.0-beta.41 → `b2e95d7d99f9e0fb0e4a4683506250bec34deeda` (2026-09-08; `release.yml` run 34216416581 publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.41` = `beta`, gitHead igual; GitHub pre-release) fecha os dois bloqueios da 2.ª
