...
**Beta line:** v0.20.0-beta.39 → `aae175e227c647a337512925b161edb27bb90051` (2026-09-07; `release.yml` run PENDING publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.39` = `beta`, gitHead igual; GitHub pre-release) fecha a classe que a
