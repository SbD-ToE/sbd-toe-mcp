...
**Beta line:** v0.20.0-beta.44 → `4af9197598715a26d993d4803997851d945c96ae` (2026-09-08; `release.yml` run PENDING publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.44` = `beta`, gitHead igual; GitHub pre-release) fecha o bloqueio que a
