...
**Beta line:** v0.20.0-beta.46 → `PENDING` (2026-09-08; `release.yml` run PENDING publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.46` = `beta`, gitHead igual; GitHub pre-release) fecha os dois bloqueios da 3.ª
