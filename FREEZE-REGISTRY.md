...
| v0.20.0-beta.15 | *(annotated tag on the commit that introduces this row; recorded in the close commit)* | 2026-09-03 | absorbs stable 0.18.0 — re-pin dev-build kg-2026-09-03 (`e5c3581b…`, contract v1.17) + trace_sbd_toe_requirement_sources | `beta` (pending) |
...
**Beta line:** v0.20.0-beta.15 (2026-09-03; tag on the commit introducing this row, recorded in the
close commit) absorbs stable 0.18.0 — station 3: requirement→source traceability served
