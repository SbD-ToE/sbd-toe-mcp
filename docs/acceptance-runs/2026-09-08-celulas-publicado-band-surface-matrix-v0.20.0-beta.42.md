# Matriz BANDA × SUPERFÍCIE — 2026-09-08-celulas-publicado — @shiftleftpt/sbd-toe-mcp@0.20.0-beta.42
...
| **Ausência TIPADA pelo índice (`absence_type`)** | ? | n/a | ? | ? | ? | ? | ? | n/a | ? | tem | ? | tem | ? | ? | ? | ? | n/a | ? | ? | ? | ? | ? | ? | tem | ? | ? | n/a | n/a | n/a |
...
- bandas negativas presentes, nenhuma é ausência do Manual: no_mandatory_count (explicação de serviço (texto), não uma banda) — 1 superfície(s): get_sbd_toe_chapter_capability
