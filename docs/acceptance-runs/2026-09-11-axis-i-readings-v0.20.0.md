# Eixo I — LEITURAS vs oráculo do lead — 2026-09-11 — @shiftleftpt/sbd-toe-mcp@0.20.0

**Medido contra:** repo (dist/index.js).
...
Veredictos: **6 SERVIDO · 0 SERVIDO-MAL · 0 NÃO SERVIDO** (de 6).
...
| GR-04 | PAPEL/MOMENTO | **SERVIDO** | 4/4 | get_guide_by_role |
...
| artefactos que a capacidade exige | sim | 16 no brief · 0 na vista IMPL |
| papéis envolvidos e momento no ciclo | sim | 58 atribuições na fase |
...
| Peça do must-have | Servida | Evidência |
|---|---|---|
| user stories aplicáveis ao papel | sim | 10 histórias / 10 atribuições |
| o momento no ciclo | sim | 10 atribuições com fase |
| o que o PO decide vs o que delega | sim | 5 que APROVA vs 5 em que é CONSULTADO, 10/10 com âncora verbatim. RESSALVA: a fonte declara que NÃO afirma RACI completo — «delega» não é publicado como tal; o que se serve é decide vs não-decide, que é o que existe. |
| a evidência que fica | sim | DoD/evidência nas histórias |

> denominadores declarados: 10 atribuições / 10 histórias
...
| Peça do must-have | Servida | Evidência |
|---|---|---|
| arranque barato (quick-start) | sim | 581 tk |
