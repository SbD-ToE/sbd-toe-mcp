# Axis H — requirement-selection vs golden oracle — 2026-08-31 — @shiftleftpt/sbd-toe-mcp@0.20.0-beta.6
...
- oráculo: must-have 10, discutíveis 0, must-NOT 75 · prepare status `ready_for_codegen`, seleccionados 36
- **excesso (nem exigido nem proibido — a discussão vai estar aqui):** API-001, API-002, API-003, API-004, API-005, API-006, API-007, CFG-001, CFG-002, CFG-003, CFG-004, CFG-005, ENC-002, ENC-004, ENC-005, ENC-006, ENC-007, ENC-008, LOG-002, LOG-003, LOG-004, LOG-005, LOG-006, LOG-007, LOG-008, LOG-009
