# Axis H — requirement-selection vs golden oracle — 2026-09-10 — @shiftleftpt/sbd-toe-mcp@0.20.0-beta.47

Oracle: `golden-selection-cases.md` **v1 (closed 2026-08-31, ratified in block)** (programme lead's; read-only). Bundle: **v1.12.0** (`release`, contract v1.25). Measurement only — **not part of the promotion gate**. "Discutíveis" lines are neutral; GC-01 carries the oracle's contamination note. Verdict measured on `prepare` (the selection instrument); `consult` (task-derived equivalent context, mapping documented in `scripts/acceptance/axis-h.mjs`) reported alongside.
...
| GC-03 | L2 | PASS | 100% | 100% | 13 | 100% | 69% | 150 |
| GC-04 | L2 | PASS | 100% | 100% | 11 | 100% | 100% | 11 |
| GC-05 | L2 | PASS | 100% | 100% | 56 | 16% | 100% | 4 |
| GC-06 | L3 | PASS | 100% | 100% | 43 | 100% | 100% | 46 |
| GC-07 | L3 | PASS | 100% | 100% | 12 | 22% | 100% | 0 |
...
- oráculo: must-have 29, discutíveis 4, must-NOT 117 · prepare status `ready_for_codegen`, seleccionados 79
...
- oráculo: must-have 22, discutíveis 0, must-NOT 106 · prepare status `ready_for_codegen`, seleccionados 83
...
- oráculo: must-have 16, discutíveis 0, must-NOT 70 · prepare status `ready_for_codegen`, seleccionados 59 · overlay obligations 14
...
- oráculo: must-have 18, discutíveis 0, must-NOT 64 · prepare status `ready_for_codegen`, seleccionados 30
- **excesso (nem exigido nem proibido — a discussão vai estar aqui):** CIC-011, LOG-001, LOG-002, LOG-003, LOG-004, LOG-005, LOG-006, LOG-007, LOG-008, LOG-009, LOG-010, THR-008
...
- oráculo: must-have 35, discutíveis 0, must-NOT 150 · prepare status `ready_for_codegen`, seleccionados 42
...
- oráculo: must-have 10, discutíveis 0, must-NOT 76 · prepare status `ready_for_codegen`, seleccionados 39
